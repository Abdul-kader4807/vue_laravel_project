		...
		<ul class="metismenu" id="menu">
			...
			<li>
				...
				<ul>
					...
					<li> <a href="icons-feather-icons.html"><i class='bx bx-radio-circle'></i>Batches</a>
					</li>
					<li> <a href="icons-feather-icons.html"><i class='bx bx-radio-circle'></i>Adjustments</a>
					</li>
			...
			<li>
				...
				<ul>
					...
					<li> <a href="icons-feather-icons.html"><i class='bx bx-radio-circle'></i>Supplier Returns</a>
					</li>
			...
			<li>
				...
				<ul>
					...
					<li> <a href="icons-feather-icons.html"><i class='bx bx-radio-circle'></i>Manufacturer List</a>
					</li>
...
<li>
			...
			<li>
				...
				<ul>
					...
					<li> <a href="form-radios-and-checkboxes.html"><i class='bx bx-radio-circle'></i>Inventory
							Reports</a>
					</li>
			...
			<li>
				<a class="has-arrow" href="javascript:;">
					...
					<div class="menu-title">Settings-system</div>
				</a>
				<ul>
					<li> <a href="table-basic-table.html"><i class='bx bx-radio-circle'></i>Settings</a>
					</li>
					<!-- <li> <a href="table-datatable.html"><i class='bx bx-radio-circle'></i>Data Table</a>
					</li> -->
				</ul>
