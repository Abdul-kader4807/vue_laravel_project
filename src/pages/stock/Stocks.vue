...
// const debouncedFetchstocks = debounce(fetchUsers, 300);
                    ...
                    <form action="#">
                        <div class="col-sm-6 col-md-12 text-end mb-2 d-flex justify-content-end">
                            <div id="example2_filter" class="dataTables_filter"><label><input v-model="search"
                                        @input="fetchstocks" type="search" class="form-control form-control-sm"
                        ...
                        <table id="example2" class="table table-striped table-bordered dataTable" role="grid"
                            ...
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                                        aria-label="Start date: activate to sort column ascending"
                                        style="width: 107.422px;">Qty</th>
                                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                                        aria-label="Start date: activate to sort column ascending"
                                        style="width: 107.422px;">Uom name</th>
                                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                                        aria-label="Start date: activate to sort column ascending"
                                        style="width: 107.422px;">Remark</th>
                            ...
                            <tbody>
                                <tr v-for="stock in stocks" role="row" class="odd">
                                    <td class="sorting_1">{{ stock.id }}</td>
                                    ...
                                    <td class="btn btn-group">
                                        <!-- <RouterLink :to="`/stocks/edit/${stock.id}`" class="btn btn-info">
                                            Edit
                                        </RouterLink> -->

                                        <a class="btn btn-danger" @click="deletestocks(stock.id)">Delete</a>
                                    </td>
                                </tr>
                            </tbody>
                ...
                <div class="list-pagination col-md-12 d-flex justify-content-end cursor-pointer">
                    <ul class="pagination">
                        <li v-for="page in links.links" :key="page.label" class="page-item"><a
                                ...
                                @click="fetchstocks(page.url)" data-i="1" data-page="1">{{
