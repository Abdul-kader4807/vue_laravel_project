...
// const debouncedFetchcategory = debounce(fetchUsers, 300);
                    ...
                    <form action="#">
                        <div class="col-sm-6 col-md-12 text-end mb-2 d-flex justify-content-end">
                            <div id="example2_filter" class="dataTables_filter"><label><input v-model="search"
                                        @input="fetchCategories" type="search" class="form-control form-control-sm"
                            ...
                            <tbody>
                                <tr v-for="category in categories" role="row" class="odd">
                                    ...
                                    <td class="btn btn-group">
                                        <RouterLink :to="`/category/edit/${category.id}`" class="btn btn-info">
                                            Edit
                                        </RouterLink>

                                        <a class="btn btn-danger" @click="deleteCategories(category.id)">Delete</a>
                                    </td>
                                </tr>
                            </tbody>
                ...
                <div class="list-pagination col-md-12 d-flex justify-content-end cursor-pointer">
                    <ul class="pagination">
                        <li v-for="page in links.links" :key="page.label" class="page-item"><a
                                ...
                                @click="fetchCategories(page.url)" data-i="1" data-page="1">{{
